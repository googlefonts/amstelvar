...
# instances
instances = [
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wght100-wdth125.ufo", location=dict(wght=100, wdth=125, opsz=144), styleName="opsz144-wght100-wdth125", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wght100-wdth075.ufo", location=dict(wght=100, wdth=87, opsz=144), styleName="opsz144-wght100-wdth075", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wght100-wdth50.ufo", location=dict(wght=100, wdth=75, opsz=144), styleName="opsz144-wght100-wdth50", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
	
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wght900-wdth125.ufo", location=dict(wght=900, wdth=125, opsz=144), styleName="opsz144-wght900-wdth125", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wght900-wdth075.ufo", location=dict(wght=900, wdth=76, opsz=144), styleName="opsz144-wght900-wdth075", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wght900-wdth50.ufo", location=dict(wght=900, wdth=75, opsz=144), styleName="opsz144-wght900-wdth50", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
	
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wdth125.ufo", location=dict(wght=400, wdth=125, opsz=144), styleName="opsz144-wdth125", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wdth075.ufo", location=dict(wght=400, wdth=80, opsz=144), styleName="opsz144-wdth075", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
#	dict(fileName="instances/Amstelvar-Roman-opsz144-wdth50.ufo", location=dict(wght=400, wdth=75, opsz=144), styleName="opsz144-wdth50", familyName=familyName, postScriptFontName=None, styleMapFamilyName=None, styleMapStyleName=None),
]
for instance in instances:
...
designSpace = "sources/Amstelvar-NewSpaceNames/Roman/Amstelvar-Roman-010.designspace"
sources = [
	dict(path="master_ufo/Amstelvar-Roman.ufo", name="Amstelvar-Roman.ufo", location=dict( wght=400, wdth=100, opsz=14, GRAD=0), styleName="Regular", familyName=familyName, copyInfo=True),
	
##	Main 
	dict(path="master_ufo/Amstelvar-Roman-GRAD-1.ufo", name="Amstelvar-Roman-GRAD-1.ufo", location=dict(GRAD=-1), styleName="GRAD-1", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-GRAD1.ufo", name="Amstelvar-Roman-GRAD1.ufo", location=dict(GRAD=1), styleName="GRAD1", familyName=familyName, copyInfo=False),	
...
##	Parametric
	dict(path="master_ufo/Amstelvar-Roman-XOPQ18.ufo", name="Amstelvar-Roman-XOPQ18.ufo", location=dict(XOPQ=18), styleName="XOPQ18", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-XOPQ263.ufo", name="Amstelvar-Roman-XOPQ263.ufo", location=dict(XOPQ=263), styleName="XOPQ263", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-XTRA324.ufo", name="Amstelvar-Roman-XTRA324.ufo", location=dict(XTRA=324), styleName="XTRA324", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-XTRA640.ufo", name="Amstelvar-Roman-XTRA640.ufo", location=dict(XTRA=640), styleName="XTRA640", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YOPQ15.ufo", name="Amstelvar-Roman-YOPQ15.ufo", location=dict(YOPQ=15), styleName="YOPQ15", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YOPQ132.ufo", name="Amstelvar-Roman-YOPQ132.ufo", location=dict(YOPQ=132), styleName="YOPQ132", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTLC420.ufo", name="Amstelvar-Roman-YTLC420.ufo", location=dict(YTLC=420), styleName="YTLC420", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTLC570.ufo", name="Amstelvar-Roman-YTLC570.ufo", location=dict(YTLC=570), styleName="YTLC570", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTUC500.ufo", name="Amstelvar-Roman-YTUC500.ufo", location=dict(YTUC=500), styleName="YTUC500", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTUC1000.ufo", name="Amstelvar-Roman-YTUC1000.ufo", location=dict(YTUC=1000), styleName="YTUC1000", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTAS500.ufo", name="Amstelvar-Roman-YTAS500.ufo", location=dict(YTAS=500), styleName="YTAS500", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTAS983.ufo", name="Amstelvar-Roman-YTAS983.ufo", location=dict(YTAS=983), styleName="YTAS983", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTDE-138.ufo", name="Amstelvar-Roman-YTDE-138.ufo", location=dict(YTDE=-138), styleName="YTDE-138", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTDE-500.ufo", name="Amstelvar-Roman-YTDE-500.ufo", location=dict(YTDE=-500), styleName="YTDE-500", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTFI425.ufo", name="Amstelvar-Roman-YTFI425.ufo", location=dict(YTFI=425), styleName="YTFI425", familyName=familyName, copyInfo=False),
...
##	Multivars
	...
	dict(path="master_ufo/Amstelvar-Roman-opsz144-wght100-wdth125.ufo", name="Amstelvar-Roman-opsz144-wght100-wdth125.ufo", location=dict(wght=100, opsz=144, wdth=125, ), styleName="opsz144-wght100-wdth125", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-opsz144-wght400-wdth125.ufo", name="Amstelvar-Roman-opsz144-wght400-wdth125.ufo", location=dict(wght=400, opsz=144, wdth=125, ), styleName="opsz144-wght400-wdth125", familyName=familyName, copyInfo=False),
	...
	dict(path="master_ufo/Amstelvar-Roman-opsz144-wght900-wdth100.ufo", name="Amstelvar-Roman-opsz144-wght900-wdth100.ufo", location=dict(wght=900, opsz=144, wdth=100), styleName="opsz144-wght900-wdth100", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-opsz144-wght900-wdth125.ufo", name="Amstelvar-Roman-opsz144-wght900-wdth125.ufo", location=dict(wght=900, opsz=144, wdth=125), styleName="opsz144-wght900-wdth125", familyName=familyName, copyInfo=False),
...
for fileName in sources:
	...
	if fileName not in ['Amstelvar-Roman-opsz144.ufo', 'Amstelvar-Roman-wght100.ufo', 'Amstelvar-Roman-wght900.ufo', 'Amstelvar-Roman-wdth125.ufo', 'Amstelvar-Roman-wdth50.ufo']:
