...
##	Parametric
	dict(path="master_ufo/Amstelvar-Roman-XOPQmin.ufo", name="Amstelvar-Roman-XOPQmin.ufo", location=dict(XOPQ=36), styleName="XOPQmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-XOPQmax.ufo", name="Amstelvar-Roman-XOPQmax.ufo", location=dict(XOPQ=526), styleName="XOPQmax", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-XTRAmin.ufo", name="Amstelvar-Roman-XTRAmin.ufo", location=dict(XTRA=444), styleName="XTRAmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-XTRAmax.ufo", name="Amstelvar-Roman-XTRAmax.ufo", location=dict(XTRA=1104), styleName="XTRAmax", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YOPQmin.ufo", name="Amstelvar-Roman-YOPQmin.ufo", location=dict(YOPQ=29), styleName="YOPQmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YOPQmax.ufo", name="Amstelvar-Roman-YOPQmax.ufo", location=dict(YOPQ=224), styleName="YOPQmax", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTLCmin.ufo", name="Amstelvar-Roman-YTLCmin.ufo", location=dict(YTLC=445), styleName="YTLCmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTLCmax.ufo", name="Amstelvar-Roman-YTLCmax.ufo", location=dict(YTLC=600), styleName="YTLCmax", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTUCmin.ufo", name="Amstelvar-Roman-YTUCmin.ufo", location=dict(YTUC=550), styleName="YTUCmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTUCmax.ufo", name="Amstelvar-Roman-YTUCmax.ufo", location=dict(YTUC=850), styleName="YTUCmax", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTASmin.ufo", name="Amstelvar-Roman-YTASmin.ufo", location=dict(YTAS=667), styleName="YTASmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTASmax.ufo", name="Amstelvar-Roman-YTASmax.ufo", location=dict(YTAS=867), styleName="YTASmax", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTDEmin.ufo", name="Amstelvar-Roman-YTDEmin.ufo", location=dict(YTDE=140), styleName="YTDEmin", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Amstelvar-Roman-YTDEmax.ufo", name="Amstelvar-Roman-YTDEmax.ufo", location=dict(YTDE=340), styleName="YTDEmax", familyName=familyName, copyInfo=False),
...
axes = [
	...
	dict(minimum=29, maximum=224, default=124, name="YOPQ", tag="YOPQ", labelNames={"en": "YOPQ"}, map=[]),
